# B_MNL_Bandit/base_line/3qucb/embedllm_train.py
import os
...
def parse_args():
    ap = argparse.ArgumentParser(description="Baseline (3) QUCB on EmbedLLM(HF csv pivot)")
...
def main():
    ...
    run_pipeline_with_env(df, models, cost_map, args, config, baseline_queue_env_func=qucb_queue_env)
