...
def parse_args():
    ap = argparse.ArgumentParser(description="Baseline (4) QThS on EmbedLLM(HF csv pivot)")
...
def main():
    ...
    run_pipeline_with_env(df, models, cost_map, args, config, baseline_queue_env_func=qths_queue_env)
