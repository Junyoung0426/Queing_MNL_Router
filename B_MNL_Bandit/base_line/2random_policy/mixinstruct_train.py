# Base line/all_rand/mixinstruct_train.py
import os
...
common_dir = os.path.join(baseline_dir, "_common")
...
from queue_env import queue_env as all_rand_queue_env
...
def main():
    ...
    run_pipeline_with_env(df, models, cost_map, args, cfg, baseline_queue_env_func=all_rand_queue_env)
