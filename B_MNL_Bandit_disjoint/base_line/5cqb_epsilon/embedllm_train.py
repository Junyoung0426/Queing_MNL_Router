...
try:
    ...
    raise ImportError(f"Cannot find queue_env.py in {cqb_env_dir}")

def parse_args():
    ap = argparse.ArgumentParser()
    default_path = os.path.join(data_dir, "embedllm_dataset.csv")
...
def main():
    ...
    run_pipeline_with_env(
        ...
        args, 
        config, 
        baseline_queue_env_func=cqb_eps_queue_env
    )
