...
DEFAULT_DATA = os.path.join(data_dir, "routerbench_dataset.csv")
...
queue_config_path = os.path.join(project_dir, "B_MNL_Bandit_disjoint", "ACQB", "routerbench",  "queue_config.py")
