        ...
        for er in er_list:
            ...
            for acoef in alpha_list:
                ...
                for folder_path, output_name in targets_run:
                    ...
                    if do_search:
                        current_output_dir = (save_root / ds / k_tag / ar_tag / exp_tag / output_name / er_tag / a_tag).resolve()
                    else:
                        current_output_dir = (save_root / ds / k_tag / ar_tag / exp_tag / output_name).resolve()
    ...
    if do_search:
        ...
        for ds in args.datasets:
            ...
            for _, output_name in targets:
                ...
                assort_k = int(args.assort_K) if args.assort_K is not None else _get_assort_k(BASE_DIR, ds)
                k_tag = f"K{assort_k}"
                alg_root = (save_root / ds / k_tag / ar_tag / exp_tag / output_name).resolve()
